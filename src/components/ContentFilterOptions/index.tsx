...
interface ContentFilterOptionsProps {
    ...
    handleChange: (event: React.ChangeEvent<HTMLInputElement>, title: string) => void;
}

const ContentFilterOptions = ({ title, list, isOpen, isChecked, handleChange }: ContentFilterOptionsProps) => {
    return (
